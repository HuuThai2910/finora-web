  ...
  return (
    <div className="prod-table-wrap">
      <table className="prod-table">
        <thead><tr><th>Mã</th><th>Sản phẩm</th><th>Lãi suất</th><th>Hạn mức</th><th>Kỳ hạn</th><th>Trạng thái</th><th>Fineract</th><th /></tr></thead>
        <tbody>
          {products.map(product => (
            <tr key={product.id}>
              ...
              <td>{product.annualInterestRate}%/năm</td>
